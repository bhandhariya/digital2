...
var PatientSchema = new Schema({
    ...
    first_name:{type:Schema.Types.String,searchable:true},
    middle_name:{type:Schema.Types.String,searchable:true},
    last_name:{type:Schema.Types.String,searchable:true},
...
PatientSchema.plugin(searchable);
